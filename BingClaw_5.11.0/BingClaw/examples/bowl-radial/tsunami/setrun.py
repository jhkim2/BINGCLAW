...
bous_sw_thresh = 1.0         # Threshold for the transition to SWE
...
#-------------------
    ...
    #   [topotype, fname]
    dtopo_path = "../tmp/dtopo_test0.tt3"
    dtopo_data.dtopofiles.append([3,dtopo_path])
    dtopo_data.dt_max_dtopo = 300.
    ...
    #   [minlev, maxlev, fname]
    #qinitfile='/media/jihwan/EXT_NGI/Topo/Fjord_exp/q4.tt1'
    #rundata.qinit_data.qinitfiles.append([1, 2, qinitfile])
    #rundata.qinit_data.qinit_type = 2
    #qinitfile='/media/jihwan/EXT_NGI/Topo/Fjord_exp/q2.tt1'
    #rundata.qinit_data.qinitfiles.append([1, 2, qinitfile])
