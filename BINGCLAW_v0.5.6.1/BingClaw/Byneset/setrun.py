...
rho_a = 1.0           # Density of ambient fluid
rho_s = 1897.0        # Density of slide
n_param = 1.          # Bing rheology parameter
gamma_r = 10.0       # Reference strain rate
c_mass = 0.0          # Added Mass
hydrodrag = True      # Use hydrodrag force?
cF_hyd = 0.01         # Hydro-dynamic friction coeff.
cP_hyd = 1.0          # Hydro-dynamic pressure ceff.
remolding = True      # remolding? if not, only tauy_i is used
tauy_i = 22000.0      # initial yield strength (Pa)
tauy_r = 200.0        # residual yield strength (Pa)
...
#------------------------------
    ...
    clawdata.lower[0] = 0
    clawdata.upper[0] = 1400

    clawdata.lower[1] = 0
    clawdata.upper[1] = 1800



    # Number of grid cells: Coarsest grid
    clawdata.num_cells[0] = 14*20 # *10: 10m, *20: 5m, *50: 2m
    clawdata.num_cells[1] = 18*20
...
#-------------------
    ...
    fname = '../topo/Byneset/BynDtmDanFix1_Off.asc'
    ...
    fname = '../topo/Byneset/BynRelDan_Off.asc'
    qinitfiles.append([3,3,fname])
